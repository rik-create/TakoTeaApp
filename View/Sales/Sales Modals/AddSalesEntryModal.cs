...
{
    public partial class AddSalesEntryModal : MaterialForm
    {
        public AddSalesEntryModal()
        {
            InitializeComponent();
        ...
        {
            AddAddOnsModal addAddOnsModal = new AddAddOnsModal();
            addAddOnsModal.ShowDialog();
        }
    }
}
